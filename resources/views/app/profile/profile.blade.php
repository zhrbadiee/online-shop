                    ...
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        ...
                        <section class="row">
                            ...
                            <section class="col-6 border-bottom my-2 py-2">
                                ...
                                <section class="field-value overflow-auto">{{ auth()->user()->phone ?? '-' }}</section>
                            </section>
                                ...
                                <section class="modal-content">
                                    ...
                                    <section class="modal-body">
                                        <form class="row" method="post"
                                            ...
                                            <section class="col-6 mb-2">
                                                <label for="national_code" class="form-label mb-1">تلفن همراه 
                                                </label>
                                                <input value="{{ auth()->user()->phone ?? auth()->user()->phone }}"
                                                    type="text" name="phone" class="form-control form-control-sm"
                                                    id="phone" placeholder="تلفن همراه ">
                                            </section>

                                            <section class="col-6 mb-2">
                                                <label for="national_code" class="form-label mb-1">ایمیل 
                                                </label>
